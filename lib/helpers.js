...
/*   let fecha_extrangera = moment(pDate).tz('Europe/Lisbon').format("YYYY-MM-DD HH:mm:ss")
...
/*   let mi_fecha_str = helpers.formatDateTime(pDate);
  let mi_fecha_en_Europa = moment(helpers.formatDateTime(pDate)).tz('Europe/Lisbon').format('YYYY-MM-DD HH:mm:ss');
  console.log('Mi fecha ',mi_fecha_str,' y en europa es ',mi_fecha_en_Europa);
  let new_fecha_eur = new Date(mi_fecha_en_Europa); */
  //let salida  = helpers.timeago(pDate);

  //let new_fecha =  helpers.timeago(new Date(moment(helpers.formatDateTime(pDate)).tz('Europe/Lisbon').format('YYYY-MM-DD HH:mm:ss')));
  //return salida
}
