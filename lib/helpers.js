...
helpers.Consulta_Dni_Aux = async (pdni) => {
  ...
  try {
    const mi_token    = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6ImpnY3VlbGFwQGdtYWlsLmNvbSJ9.t6cDUspkRA3grHKMtlCq1PzTGl2nElvjFHcAIi7QBqc';
    const api_url     = `https:// dniruc.apisperu.com/api/v1/dni/${pdni}?token=${mi_token}`;
...
/*   try {
  ...
  try {
    const mi_token    = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6ImpnY3VlbGFwQGdtYWlsLmNvbSJ9.t6cDUspkRA3grHKMtlCq1PzTGl2nElvjFHcAIi7QBqc';
    const api_url     = `https:// dniruc.apisperu.com/api/v1/ruc/${pRuc}?token=${mi_token}`;
